                    ...
                    <CardContent className="flex">
                        <div className="flex-none w-auto h-auto">
                            <Image
                                ...
                                height={400}
                                priority
                                className="h-14 w-11 md:w-10 md:h-10 lg:w-[35rem] lg:h-[35rem]"
                            />
                        </div>
                        <div className="flex-grow ml-10">
                            <h1 className='text text-sm md:text-lg text-end md:text-justify line-clamp-6 md:line-clamp-none'>
