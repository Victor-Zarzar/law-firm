...
export default function CardHome() {
    return (
        <div className='container card mt-10 md:mt-20'>
            <Card className="w-auto md:max-w-[90rem] mx-auto mb-20 duration-300 hover:scale-105 hover:shadow-xl">
                <CardHeader>
                ...
                <CardContent className="flex">
                    ...
                    <div className="flex-grow ml-0 md:ml-10">
                        <h1 className='text text-sm md:text-base text-center md:text-center lg:text-justify line-clamp-6 md:line-clamp-none'>
