  ...
  return (
    <div className="w-full max-w-[95rem] h-16 md:h-16 lg:h-20">
      <div className="md:flex items-center justify-between py-4 md:py-0 md:px-10 px-6">
        ...
        <ul
          className={`md:flex md:items-center md:pb-0 absolute md:static md:z-auto z-10 left-0 w-full md:w-auto mt-4 md:mt-0 md:pl-0 pl-0 transition-all duration-500 ease-in text-center text-white md:text-black ${open ? "top-10" : "top-[-490px]"} ${open ? "h-screen flex flex-col justify-center items-center bg-red-800" : ""} $"bg-black"`}>
          {Links.map((link) => (
