  ...
  return (
    <div className='div mt-2'>
      <div className="text-center bg-red-800 h-36">
        <h1 className="text-white text-sm md:text-2xl p-14">Direito do Trabalho</h1>
      </div>
      <div className='div container mx-auto mt-14 md:mt-14 mb-14 md:mb-20'>
        <Card className="w-[310px] h-[620px] md:w-[1400px] md:h-[620px] mx-auto mb-4 md:mb-8 duration-300 hover:scale-105 hover:shadow-xl">
          <CardHeader>
          </CardHeader>
          <CardContent>
            <Image
